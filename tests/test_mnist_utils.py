...
import mnist_utils.utils as mu
...
def test_ubytes_to_np():
    ...
    test_images_from_gz = mu.ubytes2np("/Users/raghav/dev/ml/gradio-test/t10k-images-idx3-ubyte.gz", 10000, 28)
    ...
    assert test_images_from_tf == test_images_from_gz.squeeze()
...
def test_ubytes_to_png():
    ...
    num_files = 10
    mu.ubytes2png("tests/t10k-images-idx3-ubyte.gz", num_files, 28, test_dir)
...
def test_images_to_np():
    ...
    test_dir = "trial"
    create_test_dir(test_dir)
    mu.ubytes2png("tests/t10k-images-idx3-ubyte.gz", 100, 28, test_dir)
